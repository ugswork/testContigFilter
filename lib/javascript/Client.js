...
function umaContigFilter(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.mySum_XY = function (workspace_name, valx, valy, _callback, _errorCallback) {
        if (typeof workspace_name === 'function')
            throw 'Argument workspace_name can not be a function';
        if (typeof valx === 'function')
            throw 'Argument valx can not be a function';
        if (typeof valy === 'function')
            throw 'Argument valy can not be a function';
        ...
        return json_call_ajax(_url, "umaContigFilter.mySum_XY",
            [workspace_name, valx, valy], 1, _callback, _errorCallback);
    };
     ...
     this.filter_contigs = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "umaContigFilter.filter_contigs",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "umaContigFilter.status",
