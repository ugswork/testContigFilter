...
import os
from umaContigFilter.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'umaContigFilter'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from umaContigFilter.umaContigFilterImpl import umaContigFilter  # noqa @IgnorePep8
impl_umaContigFilter = umaContigFilter(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'umaContigFilter'
